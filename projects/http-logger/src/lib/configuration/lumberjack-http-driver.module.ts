...
import { lumberjackHttpDriverConfigToken } from './custom-lumberjack-http-driver-config.token.';
 ...
 */
@NgModule()
export class CustomLogHttpDriverModule {
  /**
      ...
      providers: [
        {
          ...
          useFactory: (logDriverConfig: LumberjackLogDriverConfig): CustomLumberjackHttpDriverInternalConfig => ({
            ...logDriverConfig,
